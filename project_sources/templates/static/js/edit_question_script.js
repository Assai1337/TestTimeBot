// static/js/edit_question_script.js
...
function updateOptionBehavior() {
    ...
    if (questionType === "text_input") {
        ...
        // Убираем все галочки, если выбран одиночный выбор
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Добавляем обработчик изменения типа вопроса, чтобы сохранять введенные данные
